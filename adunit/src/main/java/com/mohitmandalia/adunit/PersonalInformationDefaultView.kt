 ...
 */
class PersonalInformationDefaultView: ConstraintLayout, PersonalInformationView {
    ...
    init {
        val personalInformationViewBinding = PersonalInformationViewBinding.inflate(
        ...
        this.piContainer = personalInformationViewBinding.piContainerLayout
